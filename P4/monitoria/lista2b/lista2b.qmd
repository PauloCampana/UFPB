...
\begin{align*}
    \E{X} &= \int \limits_{-\infty}^{0} 1 - F_X(x) dx - \int \limits_0^{\infty} F_X(x) dx \\
          &= \int \limits_{-2}^0 1 - \frac{1}{10} (x + 2) dx - \int \limits_0^5 \frac{1}{5} + \frac{x}{10} + \frac{3x^2}{250} dx \\
          &= \left( x - \dfrac{x^2}{20} - \dfrac{x}{5} \right) \Big|_{-2}^0 - \left( \dfrac{x}{5} + \dfrac{x^2}{20} + \dfrac{x^3}{250} \right) \Big|_0^5 \\
          &= \left( 0 + 2 + \dfrac{1}{5} + \dfrac{2}{5} \right) - \left( 1 + \dfrac{5}{4} + \dfrac{1}{2} - 0 \right) \\
          &= \dfrac{13}{5} - \dfrac{11}{4} \\
          & = \dfrac{-3}{20}
\end{align*}
...
\begin{align*}
    \E{X} &= \int \limits_{-\infty}^{0} 1 - F_X(x) dx - \int \limits_0^{\infty} F_X(x) dx \\
          &= 0 -\int \limits_0^{\infty} F_X(x) dx \qquad \qquad \text{pois} \; F_X(x) = 0 \; \text{para} \; x < 0 \\
