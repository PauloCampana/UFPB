...
\begin{align*}
    ...
    &\Longleftrightarrow \limseq{\p{\omega \in A_n}} = 0 \\
...
\begin{align*}
    \p{|X_n - \E{X_n}| \geq \alpha} &\leq \frac{1}{\alpha^2} \Var{X_n} \\
    \limseq{\p{|X_n - \alpha| \geq \alpha}} &\leq \limseq{\frac{1}{\alpha^2}} \Var{X_n} \\
    \limseq{\p{|X_n - \alpha| \geq \alpha}} &\leq 0 \\ 
...
\begin{align*}
    ...
    &= \lim_{n \to \infty} n^r \E{(\mathbb 1_{(0,1/n^2]})^r} \\
    &= \lim_{n \to \infty} n^r \int \limits_0^{1/n^2} x^r dx \\
    &= \lim_{n \to \infty} n^r \dfrac{(1/n^2)^{r+1}}{r+1} \\
    &= \dfrac{1}{r+1} \lim_{n \to \infty} n^{-r-2} 
\end{align*}

\begin{align*}
    X_n \overset{\text{r}} \longrightarrow 0
    &\Longleftrightarrow \lim_{n \to \infty} \E{|X_n|^r} = 0 \\
    &\Longleftrightarrow \dfrac{1}{r+1} \lim_{n \to \infty} n^{-r-2} = 0\\
    &\Longleftrightarrow -r-2 < 0 \\
    &\Longleftrightarrow r > -2 \\
\end{align*}
:::

$X_n \overset{\text{r}} \longrightarrow 0$ apenas para $r > -2$.
