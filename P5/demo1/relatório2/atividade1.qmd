...
#| fig-width: 6.25
#| fig-height: 8
#| fig-cap: Razão de sexo segundo faixa etária, situação do domicílio nos censos de 2000 e 2010
...
df2000[2:20, ] |>
    ...
    transmute(
        ...
        RS_urbana = urbana_homens / urbana_mulheres,
        RS_rural = rural_homens / rural_mulheres
    ) |> pivot_longer(
        cols = -c(ano, idade)
    ) |>
    mutate(
        name = fct_relevel(name, "RS_rural", "RS_urbana", "RS_total"),
...
#| echo: false
#| warning: false
#| tbl-cap: Índice de Myers segundo sexo, situação do domicílio nos censos de 2000 e 2010
